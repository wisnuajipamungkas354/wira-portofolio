...
export const ProfesionalWork = () => {
  ...
  return (
    <LazySection>
      <Section title="Experience" subtitle="ProfesionaL Work">
        <ProfesionalWorkCard>
      ...
      <div className="bg-base-black hover:border-primary-200 rounded-2xl border border-neutral-800 p-4 md:rounded-3xl md:p-6">
        <div className="flex flex-wrap items-start justify-between">
          <div className="basis-68">
            ...
            <p className="md:display-xs-bold text-md-bold text-neutral-400 mt-1">
              {subtitle}
            </p>
          </div>
          <Image src={logoImage} alt="title" className="h8 md:12 w-auto" />
        </div>
